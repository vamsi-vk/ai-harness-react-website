  ...
  return (
    <>
      <Seo
        ...
        title="Solution for Enterprise | AI-Harness"
        description="High-value enterprise workflows where AI agents pay for themselves. Operations, customer ops, engineering, marketing, legal, finance, HR, and security."
        keywords="enterprise AI solutions, AI use cases, AI agents for operations, AI customer ops, enterprise AI workforce"
      />
      <UseCasesHero />
