...
export default function Enterprise() {
  return (
    <>
      <Seo
        path="/enterprise"
        title="Enterprise | Human + AI Workforce Platform | AI-Harness"
        ...
        keywords="enterprise AI platform, AI workforce platform, AI agents, human AI collaboration, AI workflow automation, AI governance"
      />
      <Hero />
  ...
  const roles: ExecutiveRole[] = [
    {
      ...
      questions: [
        { question: "Where can I see AI ROI across teams?", to: { pathname: "/solutions/enterprise", hash: "#role-ceo-board" } },
    ...
    },
    {
      ...
      questions: [
        { question: "How do we standardize AI execution across functions?", to: { pathname: "/solutions/enterprise", hash: "#role-coo" } },
        { question: "How can operations teams improve throughput quickly?", to: { pathname: "/solutions/enterprise", hash: "#operations" } },
    ...
    },
    {
      ...
      questions: [
        { question: "How does this integrate with our existing stack?", to: { pathname: "/solutions/enterprise", hash: "#role-cio-cto" } },
    ...
    },
    {
      ...
      questions: [
        { question: "How do we track spend by team and outcome?", to: { pathname: "/solutions/enterprise", hash: "#role-cfo" } },
        { question: "How are budget controls enforced?", to: "/security" },
        { question: "Where can I review finance-focused workflows?", to: { pathname: "/solutions/enterprise", hash: "#finance" } },
      ],
    },
  ];
      ...
      <Container className="relative">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <p className="mt-5 text-sm text-ink-500">
            AI as first-class teammates ┬À Unified project & task workflows ┬À End-to-end governance and auditability
          </p>
        </div>
...
function ValueProps() {
  ...
  const stats = [
    ...
    { value: 4.2, decimals: 1, suffix: "├ù", label: "Increase in throughput per operations team" },
...
function CountUpValue({
  ...
  useEffect(() => {
    ...
    const startAnimation = () => {
      ...
      // never paint a half-state (target ÔåÆ 0 ÔåÆ tween).
      setValue(0);
      rafRef.current = requestAnimationFrame(tick);
    };
    ...
    const observer = new IntersectionObserver(
      ...
      // brief `target ÔåÆ 0` swap happens while the user's eye is still above
            ...
            <div className="rounded-2xl border border-white/20 bg-white/[0.08] p-5 backdrop-blur">
              ...
              <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
                {useCases.map((item) => (
                  <Link
                    key={item.label}
                    to={{ pathname: "/solutions/enterprise", hash: item.hash }}
