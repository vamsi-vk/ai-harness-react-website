...
export default function NotFound() {
  // Best-effort 404 hint for crawlers/share bots that DO execute JS.
  // (A pure SPA on Vercel cannot return a 200 → 404 status code from React,
  // so this <meta> + Seo `noindex` is the most truthful signal we can emit.)
  useEffect(() => {
    document.title = "404 · Page not found · AI-Harness";
  }, []);
  ...
  return (
    <>
      <Seo
        ...
        description="The page you were looking for does not exist on AI-Harness. Head back to the home page or explore the platform."
        noindex
      />
