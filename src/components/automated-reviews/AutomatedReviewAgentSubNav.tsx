...
export const AUTOMATED_REVIEW_AGENT_BASE = "/agents/automated-reviews";

export const AUTOMATED_REVIEW_AGENT_TABS = [
  {
    id: "overview",
    label: "Overview",
    to: AUTOMATED_REVIEW_AGENT_BASE,
  },
] as const;

export function AutomatedReviewAgentSubNav() {
...
export function AutomatedReviewAgentChrome({ children }: { children: ReactNode }) {
  return (
    <div className="font-poppins">
      <div aria-hidden className="h-16 shrink-0" />
      <AutomatedReviewAgentSubNav />
      {children}
    </div>
  );
}
