...
/** React Bits Lightfall — colorful light streaks with cursor glow. */
const Lightfall: FC<LightfallProps> = ({
  ...
  useEffect(() => {
    ...
    // Keep pointer events on canvas for mouse glow; wrapper is behind content.
    ...
    // Listen on window so CTA clicks still work while cursor light tracks.
    if (mouseInteraction) {
