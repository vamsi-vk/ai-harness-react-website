...
const base =
  "inline-flex max-w-full items-center justify-center gap-2 rounded-lg font-semibold tracking-tight transition-all duration-200 whitespace-normal text-center sm:whitespace-nowrap";
